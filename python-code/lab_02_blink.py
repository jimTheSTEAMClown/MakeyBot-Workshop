...
# https://eupl.eu/
# Program/Design Name:      lab_02_blink.py
# Description:    Blink an LED - refactored using a def main() function.
#                 Introduces the main() pattern used in all future labs.
# Revision:
...
def main():
    """Main program — sets up the LED and runs the blink loop."""
    ...
    print("Lab 02 - Blink with main() starting...")
